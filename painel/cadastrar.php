<?php 
    ...
    if(!isset($_SESSION['logado'])) {
        echo "<script>alert('É necessário estar logado para acessar essa página!')</script>";
                ...
                <div class="col dropdown d-flex align-items-center justify-content-end">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            ...
                            <a class="dropdown-item text-end" href="../controllers/logout.php">
                                <small>Sair</small>
                            </a>
                        </li>
                    </ul>
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        <aside class="bg-custom text-light py-4" style="width: 250px;">
            <div class="menu">
                ...
                <a href="../controllers/logout.php" class="w-100 d-flex align-items-center gap-2 link-light text-decoration-none mt-2 py-3 px-3 ms-1 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(-.125rem, 0, 0);">
        ...
        <main class="col h-100 text-light p-4">
            ...
            <form action="../controllers/UsuarioController.php" class="bg-custom rounded col-12 py-3 px-4" method="post" >
                
                <div class="mb-3 row">
                    <label for="usuario" class="col-sm-2 col-form-label">Usuário:</label>
                    <div class="col-sm-10">
                        <input type="text" name="nome" class="form-control bg-dark text-light border-dark" id="usuario" placeholder="Ex: Admin">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="confirmarSenha" class="form-control bg-dark text-light border-dark" id="confSenha">
                    </div>
                </div>

                <div class="d-flex justify-content-end">
                    <button type="submit" name="btn-cadastrarUsuario" class="btn btn-light">Cadastrar</button>
                </div>
            </form>
