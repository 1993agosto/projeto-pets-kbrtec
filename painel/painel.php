                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a href="editar.php?id=<?=$row->idUsuario?>" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
                                        ...
                                        <form action="../controllers/UsuarioController.php" method="post">
                                            ...
                                            <button name="btn-deletar" type="submit" class="btn btn-danger d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Deletar">
