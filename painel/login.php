        ...
        <div class="container">
            <div class="bg-custom mx-auto row col-8 rounded shadow-sm overflow-hidden">
                ...
                <div class="col-6 d-flex align-items-center p-5">
                    <form action="../controllers/UsuarioController.php" method="post" class="form w-100">
                        ...
                        <div class="row row-gap-3">
                            ...
                            <div class="col-12 form-group text-light">
                                ...
                                <input type="password" name="senha" class="form-control bg-dark border-dark text-light" id="password">
                                <!-- <small class="bg-danger rounded py-1 px-2 mt-1 d-block text-light">Erro</small> -->
                            ...
                            <div class="col-12">
                                <button type="submit" name="btn-autenticar" class="btn btn-light mt-3">Entrar</button>
                            </div>
                        </div>
                    </form>
                </div>
