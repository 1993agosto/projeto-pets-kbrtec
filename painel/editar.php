...
<body class="bg-dark h-100">
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        ...
        <main class="col h-100 text-light p-4">
            ...
            <form action="../controllers/UsuarioController.php" method="post" class="bg-custom rounded col-12 py-3 px-4">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nome" class="form-control bg-dark text-light border-dark" id="usuario" value=<?=$dados->nomeUsuario?>>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" name="email" class="form-control bg-dark text-light border-dark" id="email"value=<?=$dados->emailUsuario?>>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" name="btn-editar" class="btn btn-light">Salvar</button>
                </div>
            </form>
